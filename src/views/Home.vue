          ...
          <div class="column is-half" v-for="pokemon in pokemonList">
            <div class="card">
              ...
              <footer class="card-footer">
                ...
                <button
                  v-if="!pokemon.isDead"
                  class="button is-info card-footer-item is-small"
